...
\begin{figure}[ht]
  \centering
  % \includegraphics[width=0.8\linewidth]{build/magnet_1.png}
  \caption{Plots fuer $K_b T = 1$, zufaellige Spins.}
\end{figure}
\begin{figure}[ht]
  \centering
  % \includegraphics[width=0.8\linewidth]{build/magnet_2.png}
  \caption{Plots fuer $K_b T = 2$, zufaellige Spins.}
\end{figure}
\begin{figure}[ht]
  \centering
  % \includegraphics[width=0.8\linewidth]{build/magnet_3.png}
